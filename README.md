...
│   └── package.json
├── supabase/
│   ├── migrations/       # Migraciones SQL, en orden (28 hasta ahora)
│   ├── functions/        # Edge Functions (Deno): registrar-venta, cerrar-caja,
│   │                     #   actualizar-estado-transferencia, eliminar-restablecer-venta,
